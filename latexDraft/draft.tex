...
\begin{document}
	...
	\begin{figure}[h!]
		\centering
		\subfigure[a]{\label{fig:3a}\includegraphics[width=0.5\textwidth]{image008.jpg}}%
		\subfigure[b]{\label{fig:3b}\includegraphics[width=0.4\textwidth]{image009.jpg}}%
		
		\subfigure[c]{\label{fig:3c}\includegraphics[width=0.4\textwidth]{image010.jpg}}%
		\subfigure[c]{\label{fig:3d}\includegraphics[width=0.5\textwidth]{image011.jpg}}%
		
		\subfigure[c]{\label{fig:3d}\includegraphics[width=0.5\textwidth]{image012.jpg}}%
		\subfigure[c]{\label{fig:3d}\includegraphics[width=0.5\textwidth]{image013.jpg}}%
		\caption{Neuropixel}
	\end{figure}
